...
class RewardQuestSDX : RewardQuest
{
    ...
    public override void GiveReward(EntityPlayer player)
    {
        ...
        {
            EntityFarmingAnimal questEntity = GameManager.Instance.World.Entities.dict[base.OwnerQuest.SharedOwnerID] as EntityFarmingAnimal;
            if (questEntity == null)
                return;
            questEntity.myQuestJournal.AddQuest(quest);
